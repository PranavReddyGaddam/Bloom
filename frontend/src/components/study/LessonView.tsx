...
import {
  ArrowLeft, Brain, ClipboardList, RotateCcw, BookOpen, GraduationCap,
} from 'lucide-react'
...
const TAB_META: Record<'summary' | 'flashcards' | 'quiz', { label: string; icon: React.ReactNode }> = {
...
export function LessonView({
  ...
  const available = (['summary', 'flashcards', 'quiz'] as const).filter(tab => {
