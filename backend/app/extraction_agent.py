...
async def _describe_page(ai_service: BloomAI, page: fitz.Page) -> str:
...
async def extract_structured(file_path: str) -> str:
    ...
    try:
        for page_num in range(doc.page_count):
            ...
            if classification == "title":
                ...
                description = await _describe_page(ai_service, page)
                merged = raw_text
                if description:
